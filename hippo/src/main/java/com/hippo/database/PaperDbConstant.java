...
public interface PaperDbConstant {
    ...
    String PAPER_SOCKET_SERVER_URL = "fugu_socket_server_url";
    ...
    String PAPER_USER_ID = "hippo_user_id";
    String PAPER_DEVICE_TOKEN = "hippo_device_token";
    String PAPER_GET_AGENT_RESPONSE_MAP = "fugu_get_agent_response_map";
}
