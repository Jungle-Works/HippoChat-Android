...
public class FuguPutUserDetailsResponse {
    ...
    public class Data {
        ...
        @Expose
        private int editDeleteDuration = 0;
        ...
        public List<BusinessLanguages> getBusinessLanguages() {
            return businessLanguages;
        }

        public void setBusinessLanguages(List<BusinessLanguages> businessLanguages) {
            this.businessLanguages = businessLanguages;
        }
...
//        }
        ...
        public int getEditDeleteDuration() {
            return editDeleteDuration;
        }

        public void setEditDeleteDuration(int editDeleteDuration) {
            this.editDeleteDuration = editDeleteDuration;
        }
