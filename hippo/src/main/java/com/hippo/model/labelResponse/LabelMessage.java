...
public class LabelMessage {
    ...
    public LabelMessage(String muid, int messageType) {
        this.muid = muid;
        this.messageType = messageType;
    }


    public LabelMessage(String fromName, Long userId, String message, String sentAtUtc, boolean isSelf,
    ...
    public LabelMessage(long id, String fromName, Long userId, String message, String sentAtUtc, boolean isSelf,
    ...
    public LabelMessage(String date, boolean isDateView) {
        this.date = date;
