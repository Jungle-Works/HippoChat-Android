...
public class LabelData {
    public void setMessages(ArrayList<LabelMessage> messages) {
    ...
    public void setBotGroupId(String botGroupId) {
    ...
    public void setCreateNewChannel(int createNewChannel) {
