...
public final class PermissionRequest {
    ...
    public static final class Builder {
        ...
        public PermissionRequest build() {
            if (mRationale == null) {
                mRationale = Restring.getString(mHelper.getContext(), R.string.hippo_rationale_ask);
            }
            if (mPositiveButtonText == null) {
                mPositiveButtonText = Restring.getString(mHelper.getContext(), R.string.fugu_ok);
            }
            if (mNegativeButtonText == null) {
                mNegativeButtonText = Restring.getString(mHelper.getContext(), R.string.fugu_cancel);
            }
