...
public class CountriesAdapter extends
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hippo_item_country, parent, false);
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    if(!TextUtils.isEmpty(country.getSymbol())) {
      holder.countryNameText.setText(country.getName()+"("+country.getSymbol()+")");
    } else {
      holder.countryNameText.setText(country.getName()+" ("+country.getDialCode()+")");
