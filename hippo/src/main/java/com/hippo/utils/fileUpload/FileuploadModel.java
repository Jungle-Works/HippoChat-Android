...
public class FileuploadModel {
    ...
    public boolean isTicketAttachmentFile() {
        return isTicketAttachmentFile;
    }

    public void setTicketAttachmentFile(boolean ticketAttachmentFile) {
        isTicketAttachmentFile = ticketAttachmentFile;
    }

    boolean isTicketAttachmentFile = false;
