...
class FloatingActionButtonExpandable @JvmOverloads constructor(
    ...
    init {
        ...
        typefacePath?.let {
            try {
//                typeface = Typeface.createFromAsset(context.assets, "fonts/TitilliumWeb-SemiBold.ttf")
                typeface = Typeface.createFromAsset(context.assets, "fonts/ProximaNova-Sbold.ttf")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            toggle = TransitionInflater.from(context).inflateTransition(R.transition.float_action_button_toggle)
        }
