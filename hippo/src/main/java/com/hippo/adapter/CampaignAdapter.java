...
public class CampaignAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CampaignAdapter(Activity activity, Fragment fragment, ArrayList<Data> arrayList,
                           RecyclerView recyclerView, OnItemClickListener itemClickListener,
                           boolean hideImageDownload, String clearTxt) {
        this.arrayList = arrayList;
        this.fragment = fragment;
        this.recyclerView = recyclerView;
        this.itemClickListener = itemClickListener;
        this.hideImageDownload = hideImageDownload;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int pos) {
        if (holder instanceof CampaignAdapter.ViewHolder) {
            ...
            if (!TextUtils.isEmpty(clearTxt))
                viewHolder.clearBtn.setText(clearTxt);
            else
            ...
            if (TextUtils.isEmpty(imagePath)) {
                ...
                vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                    public boolean onPreDraw() {
                        ...
                        int finalHeight = (int) (finalWidth / 2.5);
                        viewHolder.imageView.getLayoutParams().height = finalHeight;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            readStatus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    if (arrayList.get(getAdapterPosition()).isAddedFromBroadcast()) {
//                        if (fragment != null && fragment instanceof CampaignFragment)
//                            ((CampaignFragment)fragment).fetchDataforSeeMore(arrayList.get(getAdapterPosition()).getChannelId());
//                    } else {
...
//                    }
    ...
    private void showImageDialog(Activity activity, String imgUrl, ImageView imageView) {
        try {
            ...
            profileImageIntent.putExtra("hide_download", hideImageDownload);
